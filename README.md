...
不要用括号、分号、破折号的形式，不要说空话、无意义的话（典型的AI表现例如： “人工智能技术在计算机视觉领域的突破，为遥感图像智能解译提供了新的技术方向。”“新的技术方向”这种很虚的表述。还有“具有重要价值” “但回顾研究过程，仍然存在一些问题和有待进一步突破的地方”这种表述也是。以及“将是未来值得深入探索的重要方向”这样的表述。）
````
